...
- 进度：**286 / 439**（已审 279，跳过 7，待审 153）
- 有效问题（不含已在后续 commit 修复）：**P0=0，P1=15，P2=109，P3=323**；另已在后续 commit 修复 68 条
- 平均评分：8.28/10（279 个已评分 commit）
...
| data | 6 | 2 | 0 | 4 | 2 | 8 | 6.8 |
| eval | 36 | 2 | 0 | 1 | 17 | 48 | 7.8 |
| docs | 99 | 0 | 0 | 0 | 20 | 52 | 9.4 |
| other | 5 | 0 | 0 | 2 | 4 | 5 | 7.6 |
| ingest | 20 | 0 | 0 | 1 | 10 | 34 | 7.8 |
| scripts | 19 | 0 | 0 | 1 | 8 | 25 | 8.0 |
| site | 12 | 2 | 0 | 1 | 6 | 16 | 7.6 |
| tests | 7 | 0 | 0 | 1 | 6 | 7 | 7.9 |
| web | 29 | 1 | 0 | 0 | 10 | 36 | 7.9 |
