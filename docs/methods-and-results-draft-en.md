...
**Strategy-return secondary lens** (gross-of-cost, B/C, n=125): B_arm_state Sharpe 0.42 / arm_base 0.62 / C_arm_macro 0.24 / C_placebo 0.54; SPA consistent p=0.69, MCS retains all. **Gross** — no turnover/slipp/borrow/delist/capacity, not interpretable as tradable returns. Net-cost lens (mount②, bps=5): net Sharpe ≈0.43 annualized, turnover 1.14 (non-degenerate). bps sensitivity (mount② sister script `track_b_net_cost_sweep_run`, exploratory, 2026-08-05): per-period Sharpe decays linearly from gross 0.149 (bps=0) to −0.088 at bps=50; break-even ≈31 bps (turnover 1.14 invariant across bps) → even the economic lens shows no robust tradable edge.
