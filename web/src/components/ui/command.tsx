...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* sr-only title inside DialogContent (Radix a11y contract) + the
            Command root wrapper — cmdk's Input/Item read state from this
            context; without it CommandInput throws "undefined.subscribe".
            Matches upstream shadcn CommandDialog. */}
